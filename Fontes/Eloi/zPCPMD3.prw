...
Static Function ViewDef()
	...
	oView:CreateHorizontalBox('ITE//Bibliotecas
...
Static Function ViewDef()
    ...
    Local oStruZP9 := FWFormStruct(2, cTabFilho2, {|cCampo2|   AllTrim(cCampo2) $ "ZP9_FILBML,ZP9_DOCBML,ZP9_REALCE" })
	//Cria a visualizacao do cadastro
	oView := FWFormView():New()
	oView:SetModel(oModel)
...
NS_FILHO01', 100,,, 'PASTA_FILHOS', 'ABA_FILHO001')
